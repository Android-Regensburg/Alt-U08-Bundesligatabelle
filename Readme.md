...
## Anhang
### Screenshots
![Screenshot der Bundesligatabelle-App](./docs/screenshot-1.png =400x "Obere Tabellenhälfte")
![Screenshot der Bundesligatabelle-App](./docs/screenshot-2.png =400x "Untere Tabellenhälfte")